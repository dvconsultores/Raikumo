<template>
  <div class="parallaxHistory"><section class="container containerGrid"><section class="section grid"><aside class="containerTeam" v-for="(item, index) in dataTeam" v-bind:key="index"><div class="containerFoto"><img :src="Team" alt="Circle Image"/></div><div class="containerDatos"><h2>{{item.nombre}}</h2><p><strong>{{item.cargo}}</strong><br/>{{item.twitter}}<br/><i class="fab fa-twitter"/></p></div></aside></section></section></div>
</template>
...
.containerFoto:hover {
  ...
  box-shadow: 0px 0px 1px rgb(110, 110, 17), 0px 0px 15px rgb(110, 110, 17);
}
.containerDatos {
