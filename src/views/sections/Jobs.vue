...
<script>
import axios from "axios";export default{name:"Cuerpo-app",data(){return{form:{email:"",token:""}};},methods:{guardar(){document.querySelector("input").validEmails;axios .post("http://157.230.2.213:85/raikumo/apis/v1/mail/",this.form) .then(response=>{if (response.data !==null){this.form.email="";alert("mail has been sent successfully ")}});}}};
</script>

<style scoped>
.parallaxJobs{text-align:center;overflow:hidden;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}.achicar{max-width:90%}.espacioTop{margin-top:8vmax;position:relative}.espaciobottom{margin-bottom:5vmax;position:relative}#tituloH{width:47%;height:7vmax;margin:2vmax auto;line-height:6vmax;background:linear-gradient(10deg,#000 10%,rgba(83,202,251,.5),#fff);background-size:cover;background-clip:text;-webkit-background-clip:text;color:transparent;font-family:-apple-system,BlinkMacSystemFont,Arial,sans-serif !important}h1{font-weight:700;font-size:10vmax}h2{text-align:center;line-height:35px;margin-top:5%;margin-bottom:4vmax}p{text-align:justify;font-size:2vmax;line-height:2.8vmax;margin-bottom:3vmax}aside p{text-align:center;line-height:5%;margin-bottom:7vmax}.textoFinal{text-align:end;margin-top:5%}.containerTexto{margin:auto;padding:5%;border-radius:5vmax;background:rgba(1,1,1,.9);width:100%}.contenedorTextoJobs{columns:2}input:nth-child(1){text-indent:1em;font-size:1em;width:21.3em;height:2.65em;box-shadow:0 0 2px gray;border:none;border-color:#4682b4;border-width:1px;border-radius:.3em 0 0 .3em;border-right:transparent}
input:nth-child(2){font-weight:600;font-size:1em;color:#fff;background:#161616;width:8em;height:3em;border-radius:0 .4em .4em 0;border-color:transparent;z-index:3}
</style>
